      ...
      <div className={styles.container}>
        <a href="#home" className={styles.logo} onClick={() => setIsMenuOpen(false)}>
          <svg
            ...
            className={`${styles.logoImage} ${isLoaded ? styles.logoAnimated : ''}`}
          >
        ...
        <div className={styles.actions}>
          <a href="/partner-login" className={`${styles.button} ${styles.buttonOutlined}`}>
            <TextReveal text="[ PARTNER LOGIN ]" />
          </a>
